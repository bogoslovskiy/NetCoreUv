...
namespace NetCoreUv
{
    ...
    static public class UvNative
    {
        ...
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_run(UvLoopHandle handle, int mode);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern void uv_stop(UvLoopHandle handle);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern void uv_ref(UvHandle handle);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern void uv_unref(UvHandle handle);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern void uv_close(IntPtr handle, uv_close_cb close_cb);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_listen(UvStreamHandle handle, int backlog, uv_connection_cb cb);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_accept(UvStreamHandle server, UvStreamHandle client);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_read_start(UvStreamHandle handle, uv_alloc_cb alloc_cb, uv_read_cb read_cb);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_read_stop(UvStreamHandle handle);
        ...
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_prepare_init(UvLoopHandle loopHandle, UvPrepareHandle prepareHandle);
        
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_prepare_start(UvPrepareHandle prepareHandle, uv_prepare_cb prepare_cb);
        
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_prepare_stop(UvPrepareHandle prepareHandle);
        
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_check_init(UvLoopHandle loopHandle, UvCheckHandle checkHandle);
        
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_check_start(UvCheckHandle checkHandle, uv_check_cb check_cb);
        
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_check_stop(UvCheckHandle checkHandle);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_async_init(
            UvLoopHandle loopHandle, 
            UvAsyncHandle asyncHandle,
            uv_async_cb async_cb);
        
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        static public extern int uv_async_send(UvAsyncHandle asyncHandle);
